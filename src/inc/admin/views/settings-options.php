			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'ads'; ?>" value="1"<?php checked( true, $options['ads'] ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'facebook'; ?>" value="1"<?php checked( true, $options['facebook'] ); ?>>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'personal'; ?>" value="1"<?php checked( true, $options['personal'] ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'posts'; ?>" value="1"<?php checked( true, $options['posts'] ); ?>>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'quote'; ?>" value="1"<?php checked( true, $options['quote'] ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'social'; ?>" value="1"<?php checked( true, $options['social'] ); ?>>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'mailchimp'; ?>" value="1"<?php checked( true, $options['subscribe'] ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'instagram'; ?>" value="1"<?php checked( true, $options['instagram'] ); ?>>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'twitter'; ?>" value="1"<?php checked( true, $options['twitter'] ); ?>>
