...
namespace AkshitSethi\Plugins\WidgetsBundle\Widgets {
	...
	class Personal extends WP_Widget {
		...
		?>
			...
			<div class="as-wb-personal-upload">
				<span class="as-wb-personal-preview">
				...
				<input class="as-wb-personal-url" id="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'url' ) ); ?>" type="hidden" value="<?php echo esc_attr( $instance['url'] ); ?>" />
				<button class="button" id="as-wb-personal-btn"><?php esc_html_e( 'Select Image', 'widgets-bundle' ); ?></button>

				<span class="as-wb-personal-append">
					<?php if ( ! empty( $instance['url'] ) ) : ?>
						<a href="javascript:;" id="as-wb-personal-remove"><?php esc_html_e( 'Remove', 'widgets-bundle' ); ?></a>
					<?php endif; ?>
				</span>
			</div>
